...
const useTransactionStore = create((set) => ({
    ...
    fetchTransactions: async () => {
        try {
            ...
            if (error.response && error.response.status === 403) {
                ...
                return { success: false, error: { message: "Error fetching transactions!", details: error.response&&error.response.data.message } };
            }
        }
    },
    fetchTransaction: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error fetching transaction!", details: error.response&&error.response.data.message } };
        }
    },
    addTransaction: async (transaction) => {
        try {
            ...
            return { success: false, error: { message: "Error adding transaction!", details: error.response&&error.response.data.message } };
        }
    },
    updateTransaction: async (transaction) => {
        try {
            ...
            return { success: false, error: { message: "Error updating transaction!", details: error.response&&error.response.data.message } };
        }
    },
    deleteTransaction: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error deleting transaction!", details: error.response&&error.response.data.message } };
        }
    },
    searchTransactions: async (searchTerm) => {
        try {
            ...
            return { success: false, error: { message: "Error searching transactions!", details: error.response&&error.response.data.message } };
        }
    },
    postTransaction: async (transaction) => {
        try {
            ...
            return { success: false, error: { message: "Error posting transaction!", details: error.response&&error.response.data.message } };
        }
    }
}));
