...
const useEmailStore = create((set) => ({
    ...
    fetchEmails: async () => {
        try {
            ...
            return { success: false, error: { message: "Error fetching emails!", details: error.response&&error.response.data.message } };
        }
    },
    addEmail: async (email) => {
        try {
            ...
            return { success: false, error: { message: "Error adding email!", details: error.response&&error.response.data.message } };
        }
    },
    updateEmail: async (email) => {
        try {
            ...
            return { success: false, error: { message: "Error updating email!", details: error.response&&error.response.data.message } };
        }
    },
    deleteEmail: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error deleting email!", details: error.response&&error.response.data.message } };
        }
    },
    serachEmails: async (search) => {
        try {
            ...
            return { success: false, error: { message: "Error searching emails!", details: error.response&&error.response.data.message } };
        }
    }
}))
