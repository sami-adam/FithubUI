...
const useFitnessClassStore = create((set) => ({
    ...
    fetchFitnessClasses: async () => {
        try {
            ...
            if (error.response && error.response.status === 403) {
                ...
                return { success: false, error: { message: "Error fetching fitness classes!", details: error.response&&error.response.data.message } };
            }
        }
    },
    fetchFitnessClass: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error fetching fitness class!", details: error.response&&error.response.data.message } };
        }
    },
    addFitnessClass: async (fitnessClass) => {
        try {
            ...
            return { success: false, error: { message: "Error adding fitness class!", details: error.response&&error.response.data.message } };
        }
    },
    updateFitnessClass: async (fitnessClass) => {
        try {
            ...
            return { success: false, error: { message: "Error updating fitness class!", details: error.response&&error.response.data.message } };
        }
    },
    deleteFitnessClass: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error deleting fitness class!", details: error.response&&error.response.data.message } };
        }
    },
    searchFitnessClasses: async (search) => {
        try {
            ...
            return { success: false, error: { message: "Error searching fitness classes!", details: error.response&&error.response.data.message } };
        }
    },
}));
