...
const useMembershipStore = create((set) => ({
    ...
    fetchMemberships: async () => {
        try {
            ...
            return { success: false, error: { message: "Error fetching memberships!", details: error.response&&error.response.data.message } };
        }
    },
    fetchMembership: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error fetching membership!", details: error.response&&error.response.data.message } };
        }
    },
    addMembership: async (membership) => {
        try {
            ...
            return { success: false, error: { message: "Error adding membership!", details: error.response&&error.response.data.message } };
        }
    },
    updateMembership: async (membership) => {
        try {
            ...
            return { success: false, error: { message: "Error updating membership!", details: error.response&&error.response.data.message } };
        }
    },
    deleteMembership: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error deleting membership!", details: error.response&&error.response.data.message } };
        }
    },
    searchMemberships: async (searchTerm) => {
        try {
            ...
            return { success: false, error: { message: "Error searching memberships!", details: error.response&&error.response.data.message } };
        }
    },
}));
