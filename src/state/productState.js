...
const useProductStore = create((set) => ({
    ...
    fetchProducts: async () => {
        try {
            ...
            if (error.response && error.response.status === 403) {
                ...
                return { success: false, error: { message: "Error fetching products!", details: error.response&&error.response.data.message } };
            }
        }
    },
    fetchProduct: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error fetching product!", details: error.response&&error.response.data.message } };
        }
    },
    addProduct: async (product) => {
        try {
            ...
            return { success: false, error: { message: "Error adding product!", details: error.response&&error.response.data.message } };
        }
    },
    updateProduct: async (product) => {
        try {
            ...
            return { success: false, error: { message: "Error updating product!", details: error.response&&error.response.data.message } };
        }
    },
    deleteProduct: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error deleting product!", details: error.response&&error.response.data.message } };
        }
    },
    searchProducts: async (searchTerm) => {
       try {
            ...
            return { success: false, error: { message: "Error searching products!", details: error.response&&error.response.data.message } };
        }
    },
}))
