...
const useEmployeeStore = create((set) => ({
    ...
    fetchEmployees: async () => {
        try {
            ...
            if (error.response && error.response.status === 403) {
                ...
                return { success: false, error: { message: "Error fetching employees!", details: error.response&&error.response.data.message } };
            }
        }
    },
    fetchEmployee: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error fetching employee!", details: error.response&&error.response.data.message } };
        }
    },
    addEmployee: async (employee) => {
        try {
            ...
            return { success: false, error: { message: "Error adding employee!", details: error.response&&error.response.data.message } };
        }
    },
    updateEmployee: async (employee) => {
        try {
            ...
            return { success: false, error: { message: "Error updating employee!", details: error.response&&error.response.data.message } };
        }
    },
    deleteEmployee: async (id) => {
        try {
            ...
            return { success: false, error: { message: "Error deleting employee!", details: error.response&&error.response.data.message } };
        }
    },
    searchEmployees: async (search) => {
        try {
            ...
            return { success: false, error: { message: "Error searching employees!", details: error.response&&error.response.data.message } };
        }
    },
}));
